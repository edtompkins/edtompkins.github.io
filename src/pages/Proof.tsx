    ...
    <>
      ...
      <section className="pb-16 pt-16 md:pb-[64px] md:pt-[88px]">
        <div className="mx-auto max-w-content px-6 md:px-10">
          ...
          <h1 className="m-0 font-heading text-[34px] font-normal leading-[1.1] tracking-[-0.01em] text-ink md:text-[44px]">
            The work.
          </h1>
          <Throughline className="mt-6" />
          <p className="mt-6 max-w-[64ch] font-body text-[19px] leading-[1.65] text-ink-70">
        ...
        <div className="mx-auto max-w-content px-6 md:px-10">
          <div className="grid grid-cols-1 gap-7 md:grid-cols-2">
            {HERO_CARDS.map((c) => (
              ...
              >
                <div className="border-t-2 border-amber pt-[18px] font-heading text-[62px] font-bold leading-none text-ink">
                  {c.num}
                </div>
                <h2 className="mt-5 font-ui text-[24px] font-medium leading-[1.25] text-ink">
                  {c.title}
                </h2>
          ...
          <blockquote className="mt-10 max-w-[820px] border-l-2 border-amber pl-7">
            <p className="m-0 font-editorial text-[24px] font-normal italic leading-[1.42] text-ink">
            ...
            <footer className="mt-4 font-ui text-[14px] font-medium tracking-[0.05em] text-ink-70">
              <span className="text-ink">John Cederman</span> · Senior Manager,
              Development · ran the dev team on Ed's platform
            </footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="mt-14 border-t border-ink-15 bg-paper-sunken py-16 md:py-[88px]">
        <div className="mx-auto max-w-content px-6 md:px-10">
          <h2 className="m-0 mb-2 font-heading text-[34px] font-normal leading-[1.1] tracking-[-0.01em] text-ink">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            {PATTERN.map((p) => (
              <div key={p.num} className="border-t-2 border-amber pt-5">
                <div className="font-heading text-[40px] font-bold leading-[1.04] text-ink">
                  {p.num}
                </div>
      ...
      <section className="py-16 md:py-[88px]">
        <div className="mx-auto max-w-content px-6 md:px-10">
          <h2 className="m-0 mb-2 max-w-[24ch] font-heading text-[34px] font-normal leading-[1.1] tracking-[-0.01em] text-ink">
            A different department said the same thing.
          </h2>
          <Throughline className="mt-[18px]" />
          <p className="mt-6 max-w-[64ch] font-body text-[17px] leading-[1.65] text-ink-70">
          ...
          <blockquote className="mt-9 max-w-[820px] border-l-2 border-amber pl-7">
            <p className="m-0 font-editorial text-[24px] font-normal italic leading-[1.44] text-ink">
            ...
            <footer className="mt-4 font-ui text-[14px] font-medium tracking-[0.05em] text-ink-70">
              ...
              Accounting · nominating Ed for the Palmetto Extra Mile award, March 2022
            </footer>
          </blockquote>
          <div className="mt-11 grid grid-cols-1 gap-7 md:grid-cols-2">
            {SMALL_QUOTES.map((q) => (
              ...
              >
                <p className="m-0 font-editorial text-[22px] font-normal italic leading-[1.48] text-ink">
                  {q.quote}
                </p>
                <footer className="mt-3.5 font-ui text-[13px] font-medium tracking-[0.05em] text-ink-70">
      ...
      <section className="bg-ink py-16 md:py-24">
        <div className="mx-auto flex max-w-content flex-wrap items-start gap-14 px-6 md:px-10">
          <div className="flex-none">
            <div className="border-t-2 border-amber pt-4 font-heading text-[84px] font-bold leading-[.95] text-white">
              ≈$95M
            </div>
            <div className="mt-3.5 font-ui text-[12px] font-medium tracking-[0.06em] text-inverse">
              Measurable impact · five platforms
            </div>
          </div>
          <p className="mt-2 min-w-[300px] max-w-[34ch] flex-1 font-editorial text-[24px] font-normal leading-[1.4] text-white">
      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-content px-6 md:px-10">
          <div className="max-w-[720px]">
            ...
            <p className="m-0 font-body text-[17px] leading-[1.68] text-black">
            ...
            <blockquote className="mt-7 border-l-2 border-amber pl-6">
              <p className="m-0 font-editorial text-[22px] font-normal italic leading-[1.5] text-ink">
              ...
              <footer className="mt-3.5 font-ui text-[13px] font-medium tracking-[0.05em] text-ink-70">
                <span className="text-ink">Ian Wagner</span> · worked with Ed in IT,
                2011
              </footer>
            </blockquote>
          </div>
